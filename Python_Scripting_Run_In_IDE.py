...
if __name__ == "__main__":  # Indicate that the code is a script. The script only works if it's ran directly. If it's imported into another script, this block doesn't work
    args = sys.argv # Another indication that it's a script. sys.argv is a list that contains the command-line arguments passed when running the script.
